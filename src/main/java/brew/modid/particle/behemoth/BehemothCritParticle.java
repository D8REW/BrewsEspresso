...
public class BehemothCritParticle extends SingleQuadParticle {
    public BehemothCritParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, TextureAtlasSprite sprite) {
    ...
    public record Provider(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z,
            ...
            return new BehemothCritParticle(clientLevel, x, y, z, velocityX, velocityY, velocityZ, this.sprite.get(randomSource));
        }
    }
}