...
public class LivyatanGashParticle extends SingleQuadParticle {
    private final SpriteSet sprites;

    public LivyatanGashParticle(ClientLevel clientLevel, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteSet sprites) {
    ...
    public record Provider(SpriteSet sprites) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z,
            ...
            return new LivyatanGashParticle(clientLevel, x, y, z, velocityX, velocityY, velocityZ, this.sprites);
        }
    }
}